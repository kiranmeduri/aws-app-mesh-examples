...
VSVC_PROXY_IMAGE="${ECR_IMAGE_PREFIX}/vsvcproxy"
...
deploy_images() {
    ecr_login
    for app in colorapp feapp vsvcproxy; do
        ...
        docker build -t ${ECR_IMAGE_PREFIX}/${app} --build-arg GOPROXY=${GOPROXY} ${DIR}/src/${app}
