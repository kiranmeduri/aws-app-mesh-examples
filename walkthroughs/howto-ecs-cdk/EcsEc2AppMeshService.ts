...
export interface EcsEc2AppMeshServiceProps {
    cluster: ecs.Cluster;
    mesh: appmesh.Mesh;
...
export class EcsEc2AppMeshService extends cdk.Construct {
    ...
    constructor(scope: cdk.Construct, id: string, props: EcsEc2AppMeshServiceProps) {
        super(scope, id);
    ...
    connectToMeshService(appMeshService: EcsEc2AppMeshService) {
